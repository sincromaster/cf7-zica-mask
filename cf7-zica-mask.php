 ...
 * Plugin URI: https://github.com/sincromaster/cf7-zica-mask/
 * Description: Plugin do WordPress que adiciona máscara nos campos de telefone do Contact Form 7.
 * Version: 1.0
 * Author: Jano Sousa
 * Author URI: https://github.com/sincromaster/
...
function zica_mask_activate_masked_input(){
   if( is_page('contato') ){ //mais uma vez, feito isso, o script abaixo só aparecerá na página Contato.
?>
